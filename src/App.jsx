...
const App = () => {
  ...
  const handleInputChange = (e) => {
    ...
    const isValidInput = /^[A-Za-z. \u0980-\u09FF]+$/u.test(value);
    setErrorMessage(isValidInput ? '' : 'Invalid characters. Only spaces, full stops, English letters, and Bengali letters are allowed.');

    const nameLength = value.replace(/ /g, '').length;
    setResult(nameLength % 2 === 0 ? 'Yes' : 'No');
  };
